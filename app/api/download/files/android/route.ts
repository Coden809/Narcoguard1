...
export async function GET(request: Request) {
  try {
    ...
    try {
      ...
      if (!tokenData || (tokenData.platform !== "android" && tokenData.platform !== "desktop")) {
    ...
    const filePath =
      process.env.ANDROID_APK_PATH || path.join(process.cwd(), "public", "downloads", "narcoguard-latest.apk")
